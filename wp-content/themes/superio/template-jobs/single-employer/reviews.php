	...
	<div id="review_form_wrapper" class="commentform">
		<div id="review_form">
			<?php
				...
				$comment_form['comment_field'] .= '<div class="form-group space-30"><label>'.esc_html__( 'Review', 'superio' ).'</label><textarea id="comment" class="form-control" placeholder="'.esc_attr__( 'Write Comment', 'superio' ).'" name="comment" cols="45" rows="5" aria-required="true"></textarea></div>';
