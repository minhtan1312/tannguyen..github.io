	...
	<div id="review_form_wrapper" class="commentform <?php echo trim( (have_comments())?'':'no-comment' ) ?>">
		<div id="review_form">
			<?php
				...
				$comment_form['comment_field'] .= '<div class="form-group space-30"><label>'.esc_html__( 'Your Comment', 'superio' ).'</label><textarea id="comment" class="form-control" placeholder="'.esc_attr__( 'Comment', 'superio' ).'" name="comment" cols="45" rows="5" aria-required="true"></textarea></div>';
